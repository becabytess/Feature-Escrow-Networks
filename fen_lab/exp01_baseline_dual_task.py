# ==============================================================================
# fen_lab / EXP01 — Baseline dual-task FEN family (synthetic, Colab-ready)
# ==============================================================================
# First clean-slate experiment. Paste into one Colab cell and run.
# Deps: torch, numpy only. No downloads.
#
# Tasks:
#   1) recall5    — ordered delayed recall (non-commutativity / structure)
#   2) distracted — static ID + noisy counting (dual-role + depletion)
#
# Models (~15k params, auto-matched):
#   residual_rnn  — residual tanh RNN, no escrow
#   fen_bag       — classic subtractive FEN + additive bag escrow
#   fen_roll      — subtractive FEN + channel-roll rotational escrow
#   fen_slot      — hard write-pointer / slot-indexed escrow
#   ode_fen       — soft tape head + address-shift + bag channel + subtract
#
# Known outcome (FAST_MODE, seed=1, 12 ep): bag wins distracted; slot wins
# recall5; ode_fen ~ bag on order (bag escape hatch). See exp02 for ablations.
# ==============================================================================
